import { Box, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerHeader, DrawerOverlay, Stack, useDisclosure } from "@chakra-ui/react";
import { useContext, useState } from "react";
import { APPCOLORS } from "../../../AppConstants";



import { RoomIdPane } from "./RoomIdWindow";
...
function ParticipantsPanel(props) {
    return <Stack h={'100%'}  bg={'#262626'}>sdsd</Stack>
}